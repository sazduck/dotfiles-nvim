...
-- Уменьшение ширины текущей панели (Alt + J)
set('n', '<M-C-j>', '<Cmd>resize -1<CR>', { desc = 'Resize window width down' })

-- Увеличение ширины текущей панели (Alt + K)
set('n', '<M-C-k>', '<Cmd>resize +1<CR>', { desc = 'Resize window width up' })

-- Уменьшение ширины текущей панели (Alt + H)
set('n', '<M-C-h>', '<Cmd>vertical resize -1<CR>', { desc = 'Resize window width left' })

-- Увеличение ширины текущей панели (Alt + L)
set('n', '<M-C-l>', '<Cmd>vertical resize +1<CR>', { desc = 'Resize window width right' })
